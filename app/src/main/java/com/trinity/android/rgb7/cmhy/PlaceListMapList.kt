...
class PlaceListMapList : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.place_list_map_list, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val safeArgs: PlaceListMapListArgs by navArgs()
        val catIdArgs = safeArgs.placeIdArgs
        val placeListId = catIdArgs.toInt()  // Convert PlaceListId to Int
        ...
        mapFragment?.getMapAsync(
                ...
                OnMapReadyCallback { googleMap ->
                    ...
                    viewModel.getCustomPostsMapList(placeListId, 0, "id", "desc")
                    Log.d("Response", " data access")
                    ...
                    viewModel.myCustomPosts.observe(viewLifecycleOwner, Observer { response ->
                        ...
                        if (response.isSuccessful) {
                            ...
                            for (i in 0 until itemCount!!) {
                                ...
                                } else if (itemJson.status == "Deactive") { // Alpha Marker Of Status Close Service
                                    googleMap.addMarker(
                                            MarkerOptions()
                                                    .position(LatLng(itemJson.latitude.toDouble(), itemJson.longitude.toDouble()))
                                                    .title("*" + itemJson.name)
    ...
    private fun onMarkerClick(marker: Marker) {
        ...
        val action = PlaceListMapListDirections.actionPlaceListMapListToFlowPlaceDetailDest(placeId)
